...
Shader "Lab2\Bumped Color Specular" {
Properties {
...
/*SubShader { 
        ...
        Pass {
			...
			CGPROGRAM
// Upgrade NOTE: excluded shader from DX11 and Xbox360; has structs without semantics (struct v2f members uvK,uv2,viewDirT,lightDirT)
